...
predict_a = [ True,  True, False, False,  True,  True, False, False,  True,
       False, False, False, False]

predict_b = [ True,  True,  True,  True, False,  True,  True, False,  True,
...
# This is the older version I used yesterday night
